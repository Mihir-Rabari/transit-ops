...
export default function Dashboard() {
  ...
  // Dropdown options (computed dynamically or standard)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-brand-800 to-brand-600 p-6 text-white shadow-lg">
        <div className="relative z-10 max-w-lg">
          ...
          <p className="mt-1 text-sm text-brand-100">
            Here is what's happening with your transport fleet today. All metrics are live and transaction-verified.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-white p-5 dark:border-dark-border dark:bg-dark-card shadow-sm group hover:border-brand-400 transition-all">
      ...
      {/* Empty State Banner (If no data yet) */}
      {!loading && kpis && kpis.totalVehicles === 0 && (
        <div className="rounded-xl border-2 border-dashed border-slate-200 p-8 text-center dark:border-dark-border">
      ...
      {!loading && kpis && kpis.totalVehicles > 0 && (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-dark-border dark:bg-dark-card shadow-sm">
            <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300 mb-4">Operations Summary</h4>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-dark-border dark:bg-dark-card shadow-sm">
            <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300 mb-4">Quick Shortcuts</h4>
